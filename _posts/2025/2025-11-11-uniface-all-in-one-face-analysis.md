...
- [Comparing BiSeNet and XSeg for Face Parsing]({% link _posts/2026/2026-09-07-bisenet-vs-xseg-face-parsing.md %}). The two parsers side by side, with the crop size where the small classes give out and the backbone that turned out safer.
